  ...
  return (
    <section id='about' className=' flex flex-col sm:flex-row justify-between sm:pb-4 sm:pt-10 min-h-[70vh] relative'>
      <div className=' flex-initial flex flex-col justify-between pb-5'>
        ...
        <div className='flex'>
          <a href='https://www.instagram.com' target='_blank' aria-label='social media links'><svg className='px-3 cursor-pointer sm:w-24 sm:h-24 w-20 h-20 hover:bg-white dark:hover:bg-slate-300/10 rounded-3xl' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
          ...
          <a href='https://www.twitter.com' target='_blank' aria-label='social media links'><svg className='px-3 cursor-pointer sm:w-24 sm:h-24 w-20 h-20 hover:bg-white dark:hover:bg-slate-300/10 rounded-3xl' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
          ...
          <a href='https://www.fb.com' target='_blank' aria-label='social media links'><svg className='px-3 cursor-pointer sm:w-24 sm:h-24 w-20 h-20 hover:bg-white dark:hover:bg-slate-300/10 rounded-3xl' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
            <path fill="#3F51B5" d="M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z"></path><path fill="#FFF" d="M34.368,25H31v13h-5V25h-3v-4h3v-2.41c0.002-3.508,1.459-5.59,5.592-5.59H35v4h-2.287C31.104,17,31,17.6,31,18.723V21h4L34.368,25z"></path>
          </svg></a>
          <a href='https://www.github.com' target='_blank' aria-label='social media links'><svg className='px-3 cursor-pointer sm:w-24 sm:h-24 w-20 h-20 hover:bg-white dark:hover:bg-slate-300/10 rounded-3xl' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
